...
def render_metric_card(title: str, value: str, delta: str = None, delta_type: str = "normal", icon: str = ""):
    ...
    if delta:
        ...
        delta_html = f"""<div style="color: {delta_color}; font-size: 0.85rem; font-weight: 500; display: flex; align-items: center; margin-top: 0.5rem;">
<span>{arrow} {clean_delta}</span>
</div>"""
        
    html = f"""<div class="epi-card" style="padding: 1.25rem;">
